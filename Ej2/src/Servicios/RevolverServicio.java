...
public class RevolverServicio {
    ...
    public void siguienteChorro(Revolver r){
        if(r.getPosicionActual() == 6){ 
            r.setPosicionActual(0);     //Como el revolver usa un barril de municiones, da toda la vuelta: de posicion 6 a posicion 0.
        }else{
            int pos = r.getPosicionActual();
            pos++;
            r.setPosicionActual(pos);
        }
    }
}
