...
public class Cuotas {
    ...
    public Cuotas(int numCuota, double montoTotalCuota, boolean pagada, Date fechaVencimiento, FormaPago formaPago) {
    ...
    public String toString() {
        return "Cuotas{" + "numCuota=" + numCuota + ", montoTotalCuota=" + montoTotalCuota + ", pagada=" + pagada + ", fechaVencimiento=" + fechaVencimiento + ", formaPago=" + formaPago + '}';
    }
